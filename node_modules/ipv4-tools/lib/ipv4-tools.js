...
var cymruOrigin = '.origin.asn.cymru.com', 
	cymruASN = '.asn.cymru.com',
	cymruPeers = '.peer.asn.cymru.com',
	async = require('async'), 
	http = require('http'),
	dns = require('dns');
...
IPv4Tools.prototype.getNetworkData = function(ipv4, callback){
	...
	if((typeof(ipv4) === 'undefined') || (ipv4 === null) || (ipv4.length <= 0) || (ipv4.length > 16)){callback(null, false);}
	    ...
	    var origin = ip[3] + '.' + ip[2] + '.' + ip[1] + '.' + ip[0] + cymruOrigin;      
	    var peers = ip[3] + '.' + ip[2] + '.' + ip[1] + '.' + ip[0] + cymruPeers;
	    var provider = buffer['asn'] + cymruASN;
